...
export default function TaskForm({onPredict, isPredicting, setIsPredicting}: TaskFormProps) {
    ...
    return (
        <div
            className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 fade-in animate-in fade-in duration-300">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        render={({field}) => (
                            <FormItem className="space-y-1">
                                ...
                                <p className="text-xs text-slate-500 mt-1">
                                    Be specific to improve prediction accuracy. Include technical details, complexity
                    ...
                    <div
                        className="flex flex-col sm:flex-row sm:justify-between sm:items-center pt-2 space-y-3 sm:space-y-0">
